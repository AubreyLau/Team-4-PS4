...
PS4Mesh * PS4Mesh::GenerateQuadLeft()
{
	...
	mesh->SetVertexPositions({ Vector3(-0.5f, 0.0f, 1.0f),  Vector3(-0.5f, 0.0f, 0.0f), Vector3(-0.5f, 1.0f, 1.0f),Vector3(-0.5f, 1.0f, 0.0f) });
...
PS4Mesh * PS4Mesh::GenerateQuadFront()
{
	...
	mesh->SetVertexPositions({ Vector3(0.0f, 1.0f, 0.5f),  Vector3(0.0f, 0.0f, 0.5f), Vector3(1.0f, 1.0f, 0.5f),Vector3(1.0f, 0.0f, 0.5f) });
	mesh->SetVertexTextureCoords({ Vector2(1.0f,  0.0f),Vector2(1.0f, 1.0f) ,Vector2(0.0f, 0.0f), Vector2(0.0f,  1.0f) });
	std::vector<Vector3> normals;
	std::vector<Vector3> tangents;
	std::vector<unsigned int> indices;
...
PS4Mesh * PS4Mesh::GenerateQuadDown()
{
	...
	mesh->SetVertexPositions({ Vector3(0.0f, -0.5f, 1.0f),  Vector3(0.0f, -0.5f, 0.0f), Vector3(1.0f, -0.5f, 1.0f),Vector3(1.0f, -0.5f, 0.0f) });
