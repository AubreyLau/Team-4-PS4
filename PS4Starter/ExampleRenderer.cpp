...
ExampleRenderer::ExampleRenderer(PS4Window* window) : PS4RendererBase(window)
{
	...
	CUBE = new RenderObject((MeshGeometry*)setMesh("/app0/RobotBody.msh"), (ShaderBase*)testShader, (TextureBase*)defaultTexture);
	CUBE->SetBumpTex("/app0/test.gnf");
...
//	defaultObject[1]->SetLocalTransform(Matrix4::Scale(Vector3(1, 1,1))*Matrix4::Translation(obj1Trans));
	...
	CUBE->SetLocalTransform(Matrix4::Scale(Vector3(0.001, 0.001, 0.001))*Matrix4::Translation(Vector3(0, 0, 0)));
}
